 ...
 */
    ...
    public function getKeys() {
      ...
      foreach ( $this->getConfigurationModules() as $cfg_module ) {
        $class = 'osCommerce\\OM\\Core\\Site\\Admin\\Module\\Shipping\\' . $this->_code . '\\Configuration\\' . $cfg_module;
 ...
 */
    ...
    public function install() {
      ...
      foreach ( $OSCOM_Language->getAll() as $key => $value ) {
        if ( file_exists(OSCOM::BASE_DIRECTORY . 'Custom/Site/Shop/Languages/' . $key . '/modules/shipping/' . $this->_code . '.xml') || file_exists(OSCOM::BASE_DIRECTORY . 'Core/Site/Shop/Languages/' . $key . '/modules/shipping/' . $this->_code . '.xml') ) {
 ...
 */
    ...
    public function remove() {
      ...
      if ( file_exists(OSCOM::BASE_DIRECTORY . 'Custom/Site/Shop/Languages/' . $OSCOM_Language->getCode() . '/modules/shipping/' . $this->_code . '.xml') || file_exists(OSCOM::BASE_DIRECTORY . 'Core/Site/Shop/Languages/' . $OSCOM_Language->getCode() . '/modules/shipping/' . $this->_code . '.xml') ) {
    ...
    public function getConfigurationModules() {
      ...
      $DL = new DirectoryListing(OSCOM::BASE_DIRECTORY . 'Core/Site/Admin/Module/Shipping/' . $this->_code . '/Configuration');
      ...
      $DL = new DirectoryListing(OSCOM::BASE_DIRECTORY . 'Custom/Site/Admin/Module/Shipping/' . $this->_code . '/Configuration');
      $DL->setIncludeDirectories(false);
      $DL->setCheckExtension('php');
