...
<script type="text/javascript">
  ...
  var otmInstallLink = '<?php echo OSCOM::getLink(null, null, 'Install&Process&code=OTMCODE'); ?>';
  var otmInstallLinkIcon = '<?php echo HTML::icon('install.png'); ?>';
  ...
  function feedDataTable(data) {
    ...
    for ( var r in data.entries ) {
      ...
      newCell.innerHTML = '<a href="' + otmInstallLink.replace('OTMCODE', htmlSpecialChars(record.code)) + '">' + otmInstallLinkIcon + '</a>';
      newCell.align = 'right';
