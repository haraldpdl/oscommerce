 ...
 */
  ...
  $OSCOM_ObjectInfo = new ObjectInfo(ShippingModules::get($_GET['code']));
?>
...
<div class="infoBox">
  ...
  <form name="smEdit" class="dataForm" action="<?php echo OSCOM::getLink(null, null, 'Save&Process&code=' . $OSCOM_ObjectInfo->get('code')); ?>" method="post">

  <p><?php echo OSCOM::getDef('introduction_edit_shipping_module'); ?></p>
...
<?php
  foreach ( $OSCOM_ObjectInfo->get('keys') as $key ) {
    ...
    $OSCOM_ConfigObjectInfo = new ObjectInfo(Configuration::getEntry($Qkey->valueInt('configuration_id'), null, 'Admin\\Module\\Shipping\\' . $OSCOM_ObjectInfo->get('code')));
?>
