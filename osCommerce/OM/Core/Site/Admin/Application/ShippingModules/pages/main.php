...
<table border="0" width="100%" cellspacing="0" cellpadding="2" class="dataTable" id="shippingModulesDataTable">
  <thead>
    <tr>
      <th><?php echo OSCOM::getDef('table_heading_shipping_modules'); ?></th>
...
<script type="text/javascript">
  ...
  var dataTableName = 'shippingModulesDataTable';
  ...
  function feedDataTable(data) {
    ...
    for ( var r in data.entries ) {
      ...
      newCell.innerHTML = '<a href="' + smEditLink.replace('SMCODE', htmlSpecialChars(record.code)) + '">' + smEditLinkIcon + '</a>&nbsp;<a href="' + smUninstallLink.replace('SMCODE', htmlSpecialChars(record.code)) + '">' + smUninstallLinkIcon + '</a>';
      newCell.align = 'right';
